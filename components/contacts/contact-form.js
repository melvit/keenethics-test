  ...
  const onSubmit = (e) => {
    ...
    fetch('/contact', {
      ...
      .then((json) => {
        ...
        if (Object.keys(json.errorField)[0] === 'firstname') setFirstname(json.errorField.firstname);
        if (Object.keys(json.errorField)[0] === 'email') setEmail(json.errorField.email);
